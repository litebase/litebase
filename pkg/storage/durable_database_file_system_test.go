...
func TestDurableDatabaseFileSystem(t *testing.T) {
	test.RunWithApp(t, func(app *server.App) {
		t.Run("TestNewDurableDatabaseFileSystem", func(t *testing.T) {
		...
		t.Run("CompactWithConcurrentWrites", func(t *testing.T) {
			mockDatabase := test.MockDatabase(app)
		...
		t.Run("Compact_WithDatabaseConnection", func(t *testing.T) {
			mockDatabase := test.MockDatabase(app)

			con, err := app.DatabaseManager.ConnectionManager().Get(mockDatabase.DatabaseID, mockDatabase.DatabaseBranchID)
		...
		t.Run("GetRangeFile", func(t *testing.T) {
			mockDatabase := test.MockDatabase(app)
		...
		t.Run("SetWriteHook", func(t *testing.T) {
			mockDatabase := test.MockDatabase(app)
		...
		t.Run("TestDurableDatabaseFileSystemWithoutWriteHook", func(t *testing.T) {
			mockDatabase := test.MockDatabase(app)
