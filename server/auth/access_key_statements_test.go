...
func TestAccessKeyAuthorizes(t *testing.T) {
	...
	for _, testCase := range testCases {
		...
		if accessKey.Authorized(testCase.resource, "READ") != testCase.result {
		...
		testCases := []struct {
			...
			},
			{
				...
				statements: []*auth.AccessKeyStatement{
					...
					{Effect: "Allow", Resource: fmt.Sprintf("database:%s:*", db.DatabaseId), Actions: []string{"ANALYZE"}}},
			},
			{
				...
				statements: []*auth.AccessKeyStatement{
					{Effect: "Allow", Resource: "*", Actions: []string{"CREATE_TABLE", "DELETE", "INSERT", "READ", "SELECT", "UPDATE"}},
					{Effect: "Deny", Resource: fmt.Sprintf("database:%s:*", db.DatabaseId), Actions: []string{"ANALYZE"}},
				},
			},
			{
				...
				statements: []*auth.AccessKeyStatement{
					{Effect: "Allow", Resource: "*", Actions: []string{"CREATE_TABLE", "DELETE", "INSERT", "READ", "SELECT", "UPDATE"}},
					{Effect: "Allow", Resource: fmt.Sprintf("database:%s:branch:%s:*", db.DatabaseId, db.BranchId), Actions: []string{"ANALYZE"}},
				},
			},
			{
				...
				statements: []*auth.AccessKeyStatement{
					{Effect: "Allow", Resource: "*", Actions: []string{"CREATE_TABLE", "DELETE", "INSERT", "READ", "SELECT", "UPDATE"}},
					{Effect: "Deny", Resource: fmt.Sprintf("database:%s:branch:%s:*", db.DatabaseId, db.BranchId), Actions: []string{"ANALYZE"}},
				},
			},
			{
				...
				statements: []*auth.AccessKeyStatement{
					{Effect: "Allow", Resource: "*", Actions: []string{"CREATE_TABLE", "DELETE", "INSERT", "READ", "SELECT", "UPDATE"}},
					{Effect: "Allow", Resource: fmt.Sprintf("database:%s:branch:%s:table:%s:*", db.DatabaseId, db.BranchId, "test_table"), Actions: []string{"ANALYZE"}},
				},
			},
			{
				...
				statements: []*auth.AccessKeyStatement{
					{Effect: "Allow", Resource: "*", Actions: []string{"CREATE_TABLE", "DELETE", "INSERT", "READ", "SELECT", "UPDATE"}},
					{Effect: "Deny", Resource: fmt.Sprintf("database:%s:branch:%s:table:*", db.DatabaseId, db.BranchId), Actions: []string{"ANALYZE"}},
				},
			},
		}
	...
	test.RunWithApp(t, func(app *server.App) {
		...
		testCases := []struct {
			...
			},
			{
				...
				statements: []*auth.AccessKeyStatement{
					{Effect: "Allow", Resource: "*", Actions: []string{"FUNCTION", "READ", "UPDATE"}},
					{Effect: "Allow", Resource: fmt.Sprintf("database:%s:*", db.DatabaseId), Actions: []string{"ALTER_TABLE"}},
				},
			},
			{
				...
				statements: []*auth.AccessKeyStatement{
					{Effect: "Allow", Resource: "*", Actions: []string{"FUNCTION", "READ", "UPDATE"}},
					{Effect: "Deny", Resource: fmt.Sprintf("database:%s:*", db.DatabaseId), Actions: []string{"ALTER_TABLE"}},
				},
			},
			{
				...
				statements: []*auth.AccessKeyStatement{
					{Effect: "Allow", Resource: "*", Actions: []string{"FUNCTION", "READ", "UPDATE"}},
					{Effect: "Allow", Resource: fmt.Sprintf("database:%s:branch:%s:*", db.DatabaseId, db.BranchId), Actions: []string{"ALTER_TABLE"}},
				},
			},
			{
				...
				statements: []*auth.AccessKeyStatement{
					{Effect: "Allow", Resource: "*", Actions: []string{"FUNCTION", "READ", "UPDATE"}},
					{Effect: "Deny", Resource: fmt.Sprintf("database:%s:branch:%s:*", db.DatabaseId, db.BranchId), Actions: []string{"ALTER_TABLE"}},
				},
			},
			{
				...
				statements: []*auth.AccessKeyStatement{
					{Effect: "Allow", Resource: "*", Actions: []string{"FUNCTION", "READ", "UPDATE"}},
					{Effect: "Allow", Resource: fmt.Sprintf("database:%s:branch:%s:table:*", db.DatabaseId, db.BranchId), Actions: []string{"ALTER_TABLE"}},
				},
			},
			{
				...
				statements: []*auth.AccessKeyStatement{
					{Effect: "Allow", Resource: "*", Actions: []string{"FUNCTION", "READ", "UPDATE"}},
					{Effect: "Deny", Resource: fmt.Sprintf("database:%s:branch:%s:table:*", db.DatabaseId, db.BranchId), Actions: []string{"ALTER_TABLE"}},
				},
			},
			{
				...
				statements: []*auth.AccessKeyStatement{
					{Effect: "Allow", Resource: "*", Actions: []string{"FUNCTION", "READ", "UPDATE"}},
					{Effect: "Allow", Resource: fmt.Sprintf("database:%s:branch:%s:table:%s", db.DatabaseId, db.BranchId, "test_table"), Actions: []string{"ALTER_TABLE"}},
				},
			},
			{
				...
				statements: []*auth.AccessKeyStatement{
					{Effect: "Allow", Resource: "*", Actions: []string{"FUNCTION", "READ", "UPDATE"}},
					{Effect: "Deny", Resource: fmt.Sprintf("database:%s:branch:%s:table:%s", db.DatabaseId, db.BranchId, "test_table"), Actions: []string{"ALTER_TABLE"}},
				},
			},
		}
	...
	test.RunWithApp(t, func(app *server.App) {
		...
		testCases := []struct {
			...
			},
			{
				...
				statements: []*auth.AccessKeyStatement{
					{Effect: "Allow", Resource: "*", Actions: []string{"INSERT", "READ", "REINDEX", "SELECT", "UPDATE"}},
					{Effect: "Allow", Resource: fmt.Sprintf("database:%s:*", db.DatabaseId), Actions: []string{"CREATE_INDEX"}},
				},
			},
			{
				...
				statements: []*auth.AccessKeyStatement{
					{Effect: "Allow", Resource: "*", Actions: []string{"INSERT", "READ", "REINDEX", "SELECT", "UPDATE"}},
					{Effect: "DENY", Resource: fmt.Sprintf("database:%s:*", db.DatabaseId), Actions: []string{"CREATE_INDEX"}},
				},
			},
			{
				...
				statements: []*auth.AccessKeyStatement{
					{Effect: "Allow", Resource: "*", Actions: []string{"INSERT", "READ", "REINDEX", "SELECT", "UPDATE"}},
					{Effect: "Allow", Resource: fmt.Sprintf("database:%s:branch:%s:*", db.DatabaseId, db.BranchId), Actions: []string{"CREATE_INDEX"}},
				},
			},
			{
				...
				statements: []*auth.AccessKeyStatement{
					{Effect: "Allow", Resource: "*", Actions: []string{"INSERT", "READ", "REINDEX", "SELECT", "UPDATE"}},
					{Effect: "DENY", Resource: fmt.Sprintf("database:%s:branch:%s:*", db.DatabaseId, db.BranchId), Actions: []string{"CREATE_INDEX"}},
				},
			},
		}
	...
	test.RunWithApp(t, func(app *server.App) {
		...
		testCases := []struct {
			...
			},
			{
				...
				statements: []*auth.AccessKeyStatement{
					{Effect: "Allow", Resource: "*", Actions: []string{"INSERT", "READ", "UPDATE"}},
					{Effect: "Allow", Resource: fmt.Sprintf("database:%s:*", db.DatabaseId), Actions: []string{"CREATE_TABLE"}},
				},
			},
			{
				...
				statements: []*auth.AccessKeyStatement{
					{Effect: "Allow", Resource: "*", Actions: []string{"INSERT", "READ", "UPDATE"}},
					{Effect: "DENY", Resource: fmt.Sprintf("database:%s:*", db.DatabaseId), Actions: []string{"CREATE_TABLE"}},
				},
			},
			{
				...
				statements: []*auth.AccessKeyStatement{
					{Effect: "Allow", Resource: "*", Actions: []string{"INSERT", "READ", "UPDATE"}},
					{Effect: "Allow", Resource: fmt.Sprintf("database:%s:branch:%s:*", db.DatabaseId, db.BranchId), Actions: []string{"CREATE_TABLE"}},
				},
			},
			{
				...
				statements: []*auth.AccessKeyStatement{
					{Effect: "Allow", Resource: "*", Actions: []string{"INSERT", "READ", "UPDATE"}},
					{Effect: "DENY", Resource: fmt.Sprintf("database:%s:branch:%s:*", db.DatabaseId, db.BranchId), Actions: []string{"CREATE_TABLE"}},
				},
			},
		}
	...
	test.RunWithApp(t, func(app *server.App) {
		...
		testCases := []struct {
			...
			},
			{
				...
				statements: []*auth.AccessKeyStatement{
					{Effect: "Allow", Resource: "*", Actions: []string{"INSERT", "READ", "UPDATE"}},
					{Effect: "Allow", Resource: fmt.Sprintf("database:%s:*", db.DatabaseId), Actions: []string{"CREATE_TEMP_TABLE"}},
				},
			},
			{
				...
				statements: []*auth.AccessKeyStatement{
					{Effect: "Allow", Resource: "*", Actions: []string{"INSERT", "READ", "UPDATE"}},
					{Effect: "DENY", Resource: fmt.Sprintf("database:%s:*", db.DatabaseId), Actions: []string{"CREATE_TEMP_TABLE"}},
				},
			},
			{
				...
				statements: []*auth.AccessKeyStatement{
					{Effect: "Allow", Resource: "*", Actions: []string{"INSERT", "READ", "UPDATE"}},
					{Effect: "Allow", Resource: fmt.Sprintf("database:%s:branch:%s:*", db.DatabaseId, db.BranchId), Actions: []string{"CREATE_TEMP_TABLE"}},
				},
			},
			{
				...
				statements: []*auth.AccessKeyStatement{
					{Effect: "Allow", Resource: "*", Actions: []string{"INSERT", "READ", "UPDATE"}},
					{Effect: "DENY", Resource: fmt.Sprintf("database:%s:branch:%s:*", db.DatabaseId, db.BranchId), Actions: []string{"CREATE_TEMP_TABLE"}},
				},
			},
		}
	...
	test.RunWithApp(t, func(app *server.App) {
		...
		testCases := []struct {
			...
			},
			{
				...
				statements: []*auth.AccessKeyStatement{
					{Effect: "Allow", Resource: "*", Actions: []string{"INSERT", "READ", "UPDATE"}},
					{Effect: "Allow", Resource: fmt.Sprintf("database:%s:*", db.DatabaseId), Actions: []string{"CREATE_TEMP_TRIGGER"}},
				},
			},
			{
				...
				statements: []*auth.AccessKeyStatement{
					{Effect: "Allow", Resource: "*", Actions: []string{"INSERT", "READ", "UPDATE"}},
					{Effect: "DENY", Resource: fmt.Sprintf("database:%s:*", db.DatabaseId), Actions: []string{"CREATE_TEMP_TRIGGER"}},
				},
			},
			{
				...
				statements: []*auth.AccessKeyStatement{
					{Effect: "Allow", Resource: "*", Actions: []string{"INSERT", "READ", "UPDATE"}},
					{Effect: "DENY", Resource: fmt.Sprintf("database:%s:branch:%s:*", db.DatabaseId, db.BranchId), Actions: []string{"CREATE_TEMP_TRIGGER"}},
				},
			},
		}
	...
	test.RunWithApp(t, func(app *server.App) {
		...
		testCases := []struct {
			...
			},
			{
				...
				statements: []*auth.AccessKeyStatement{
					{Effect: "Allow", Resource: "*", Actions: []string{"INSERT", "READ", "UPDATE"}},
					{Effect: "Allow", Resource: fmt.Sprintf("database:%s:*", db.DatabaseId), Actions: []string{"CREATE_TEMP_VIEW"}},
				},
			},
			{
				...
				statements: []*auth.AccessKeyStatement{
					{Effect: "Allow", Resource: "*", Actions: []string{"INSERT", "READ", "UPDATE"}},
					{Effect: "DENY", Resource: fmt.Sprintf("database:%s:*", db.DatabaseId), Actions: []string{"CREATE_TEMP_VIEW"}},
				},
			},
			{
				...
				statements: []*auth.AccessKeyStatement{
					{Effect: "Allow", Resource: "*", Actions: []string{"INSERT", "READ", "UPDATE"}},
					{Effect: "DENY", Resource: fmt.Sprintf("database:%s:branch:%s:*", db.DatabaseId, db.BranchId), Actions: []string{"CREATE_TEMP_VIEW"}},
				},
			},
		}
	...
	test.RunWithApp(t, func(app *server.App) {
		...
		testCases := []struct {
			...
			},
			{
				...
				statements: []*auth.AccessKeyStatement{
					{Effect: "Allow", Resource: "*", Actions: []string{"INSERT", "READ", "UPDATE"}},
					{Effect: "Allow", Resource: fmt.Sprintf("database:%s:*", db.DatabaseId), Actions: []string{"CREATE_TRIGGER"}},
				},
			},
			{
				...
				statements: []*auth.AccessKeyStatement{
					{Effect: "Allow", Resource: "*", Actions: []string{"INSERT", "READ", "UPDATE"}},
					{Effect: "DENY", Resource: fmt.Sprintf("database:%s:*", db.DatabaseId), Actions: []string{"CREATE_TRIGGER"}},
				},
			},
			{
				...
				statements: []*auth.AccessKeyStatement{
					{Effect: "Allow", Resource: "*", Actions: []string{"INSERT", "READ", "UPDATE"}},
					{Effect: "DENY", Resource: fmt.Sprintf("database:%s:branch:%s:*", db.DatabaseId, db.BranchId), Actions: []string{"CREATE_TRIGGER"}},
				},
			},
		}
	...
	test.RunWithApp(t, func(app *server.App) {
		...
		testCases := []struct {
			...
			},
			{
				...
				statements: []*auth.AccessKeyStatement{
					{Effect: "Allow", Resource: "*", Actions: []string{"INSERT", "READ", "UPDATE"}},
					{Effect: "Allow", Resource: fmt.Sprintf("database:%s:*", db.DatabaseId), Actions: []string{"CREATE_VIEW"}},
				},
			},
			{
				...
				statements: []*auth.AccessKeyStatement{
					{Effect: "Allow", Resource: "*", Actions: []string{"INSERT", "READ", "UPDATE"}},
					{Effect: "DENY", Resource: fmt.Sprintf("database:%s:*", db.DatabaseId), Actions: []string{"CREATE_VIEW"}},
				},
			},
			{
				...
				statements: []*auth.AccessKeyStatement{
					{Effect: "Allow", Resource: "*", Actions: []string{"INSERT", "READ", "UPDATE"}},
					{Effect: "DENY", Resource: fmt.Sprintf("database:%s:branch:%s:*", db.DatabaseId, db.BranchId), Actions: []string{"CREATE_VIEW"}},
				},
			},
		}
	...
	test.RunWithApp(t, func(app *server.App) {
		...
		testCases := []struct {
			...
			},
			{
				...
				statements: []*auth.AccessKeyStatement{
					{Effect: "Allow", Resource: "*", Actions: []string{"CREATE_TABLE", "CREATE_INDEX", "INSERT", "READ", "SELECT", "UPDATE"}},
					{Effect: "Allow", Resource: fmt.Sprintf("database:%s:*", db.DatabaseId), Actions: []string{"CREATE_VTABLE"}},
				},
			},
			{
				...
				statements: []*auth.AccessKeyStatement{
					{Effect: "Allow", Resource: "*", Actions: []string{"CREATE_TABLE", "CREATE_INDEX", "INSERT", "READ", "SELECT", "UPDATE"}},
					{Effect: "DENY", Resource: fmt.Sprintf("database:%s:*", db.DatabaseId), Actions: []string{"CREATE_VTABLE"}},
				},
			},
			{
				...
				statements: []*auth.AccessKeyStatement{
					{Effect: "Allow", Resource: "*", Actions: []string{"CREATE_TABLE", "CREATE_INDEX", "INSERT", "READ", "SELECT", "UPDATE"}},
					{Effect: "Allow", Resource: fmt.Sprintf("database:%s:branch:%s:*", db.DatabaseId, db.BranchId), Actions: []string{"CREATE_VTABLE"}},
				},
			},
			{
				...
				statements: []*auth.AccessKeyStatement{
					{Effect: "Allow", Resource: "*", Actions: []string{"CREATE_TABLE", "CREATE_INDEX", "INSERT", "READ", "SELECT", "UPDATE"}},
					{Effect: "DENY", Resource: fmt.Sprintf("database:%s:branch:%s:*", db.DatabaseId, db.BranchId), Actions: []string{"CREATE_VTABLE"}},
				},
			},
		}
	...
	test.RunWithApp(t, func(app *server.App) {
		...
		testCases := []struct {
			...
			},
			{
				...
				statements: []*auth.AccessKeyStatement{
					{Effect: "Allow", Resource: "*", Actions: []string{"READ"}},
					{Effect: "Allow", Resource: fmt.Sprintf("database:%s:*", db.DatabaseId), Actions: []string{"DELETE"}},
				},
			},
			{
				...
				statements: []*auth.AccessKeyStatement{
					{Effect: "Allow", Resource: "*", Actions: []string{"READ"}},
					{Effect: "DENY", Resource: fmt.Sprintf("database:%s:*", db.DatabaseId), Actions: []string{"DELETE"}},
				},
			},
			{
				...
				statements: []*auth.AccessKeyStatement{
					{Effect: "Allow", Resource: "*", Actions: []string{"READ"}},
					{Effect: "Allow", Resource: fmt.Sprintf("database:%s:branch:%s:*", db.DatabaseId, db.BranchId), Actions: []string{"DELETE"}},
				},
			},
			{
				...
				statements: []*auth.AccessKeyStatement{
					{Effect: "Allow", Resource: "*", Actions: []string{"READ"}},
					{Effect: "DENY", Resource: fmt.Sprintf("database:%s:branch:%s:*", db.DatabaseId, db.BranchId), Actions: []string{"DELETE"}},
				},
			},
		}
	...
	test.RunWithApp(t, func(app *server.App) {
		...
		testCases := []struct {
			...
			},
			{
				...
				statements: []*auth.AccessKeyStatement{
					{Effect: "Allow", Resource: "*", Actions: []string{"DELETE", "READ", "UPDATE"}},
					{Effect: "Allow", Resource: fmt.Sprintf("database:%s:*", db.DatabaseId), Actions: []string{"DROP_INDEX"}},
				},
			},
			{
				...
				statements: []*auth.AccessKeyStatement{
					{Effect: "Allow", Resource: "*", Actions: []string{"DELETE", "READ", "UPDATE"}},
					{Effect: "DENY", Resource: fmt.Sprintf("database:%s:*", db.DatabaseId), Actions: []string{"DROP_INDEX"}},
				},
			},
			{
				...
				statements: []*auth.AccessKeyStatement{
					{Effect: "Allow", Resource: "*", Actions: []string{"DELETE", "READ", "UPDATE"}},
					{Effect: "Allow", Resource: fmt.Sprintf("database:%s:branch:%s:*", db.DatabaseId, db.BranchId), Actions: []string{"DROP_INDEX"}},
				},
			},
			{
				...
				statements: []*auth.AccessKeyStatement{
					{Effect: "Allow", Resource: "*", Actions: []string{"DELETE", "READ", "UPDATE"}},
					{Effect: "DENY", Resource: fmt.Sprintf("database:%s:branch:%s:*", db.DatabaseId, db.BranchId), Actions: []string{"DROP_INDEX"}},
				},
			},
		}
	...
	test.RunWithApp(t, func(app *server.App) {
		...
		testCases := []struct {
			...
			},
			{
				...
				statements: []*auth.AccessKeyStatement{
					{Effect: "Allow", Resource: "*", Actions: []string{"DELETE", "READ", "UPDATE"}},
					{Effect: "Allow", Resource: fmt.Sprintf("database:%s:*", db.DatabaseId), Actions: []string{"DROP_TABLE"}},
				},
			},
			{
				...
				statements: []*auth.AccessKeyStatement{
					{Effect: "Allow", Resource: "*", Actions: []string{"DELETE", "READ", "UPDATE"}},
					{Effect: "DENY", Resource: fmt.Sprintf("database:%s:*", db.DatabaseId), Actions: []string{"DROP_TABLE"}},
				},
			},
			{
				...
				statements: []*auth.AccessKeyStatement{
					{Effect: "Allow", Resource: "*", Actions: []string{"DELETE", "READ", "UPDATE"}},
					{Effect: "Allow", Resource: fmt.Sprintf("database:%s:branch:%s:*", db.DatabaseId, db.BranchId), Actions: []string{"DROP_TABLE"}},
				},
			},
			{
				...
				statements: []*auth.AccessKeyStatement{
					{Effect: "Allow", Resource: "*", Actions: []string{"DELETE", "READ", "UPDATE"}},
					{Effect: "DENY", Resource: fmt.Sprintf("database:%s:branch:%s:*", db.DatabaseId, db.BranchId), Actions: []string{"DROP_TABLE"}},
				},
			},
		}
	...
	test.RunWithApp(t, func(app *server.App) {
		...
		testCases := []struct {
			...
			},
			{
				...
				statements: []*auth.AccessKeyStatement{
					{Effect: "Allow", Resource: "*", Actions: []string{"DELETE", "READ", "UPDATE"}},
					{Effect: "Allow", Resource: fmt.Sprintf("database:%s:*", db.DatabaseId), Actions: []string{"DROP_TRIGGER"}},
				},
			},
			{
				...
				statements: []*auth.AccessKeyStatement{
					{Effect: "Allow", Resource: "*", Actions: []string{"DELETE", "READ", "UPDATE"}},
					{Effect: "DENY", Resource: fmt.Sprintf("database:%s:*", db.DatabaseId), Actions: []string{"DROP_TRIGGER"}},
				},
			},
			{
				...
				statements: []*auth.AccessKeyStatement{
					{Effect: "Allow", Resource: "*", Actions: []string{"DELETE", "READ", "UPDATE"}},
					{Effect: "Allow", Resource: fmt.Sprintf("database:%s:branch:%s:*", db.DatabaseId, db.BranchId), Actions: []string{"DROP_TRIGGER"}},
				},
			},
			{
				...
				statements: []*auth.AccessKeyStatement{
					{Effect: "Allow", Resource: "*", Actions: []string{"DELETE", "READ", "UPDATE"}},
					{Effect: "DENY", Resource: fmt.Sprintf("database:%s:branch:%s:*", db.DatabaseId, db.BranchId), Actions: []string{"DROP_TRIGGER"}},
				},
			},
		}
	...
	test.RunWithApp(t, func(app *server.App) {
		...
		testCases := []struct {
			...
			},
			{
				...
				statements: []*auth.AccessKeyStatement{
					{Effect: "Allow", Resource: "*", Actions: []string{"DELETE", "READ", "UPDATE"}},
					{Effect: "Allow", Resource: fmt.Sprintf("database:%s:*", db.DatabaseId), Actions: []string{"DROP_VIEW"}},
				},
			},
			{
				...
				statements: []*auth.AccessKeyStatement{
					{Effect: "Allow", Resource: "*", Actions: []string{"DELETE", "READ", "UPDATE"}},
					{Effect: "DENY", Resource: fmt.Sprintf("database:%s:*", db.DatabaseId), Actions: []string{"DROP_VIEW"}},
				},
			},
			{
				...
				statements: []*auth.AccessKeyStatement{
					{Effect: "Allow", Resource: "*", Actions: []string{"DELETE", "READ", "UPDATE"}},
					{Effect: "Allow", Resource: fmt.Sprintf("database:%s:branch:%s:*", db.DatabaseId, db.BranchId), Actions: []string{"DROP_VIEW"}},
				},
			},
			{
				...
				statements: []*auth.AccessKeyStatement{
					{Effect: "Allow", Resource: "*", Actions: []string{"DELETE", "READ", "UPDATE"}},
					{Effect: "DENY", Resource: fmt.Sprintf("database:%s:branch:%s:*", db.DatabaseId, db.BranchId), Actions: []string{"DROP_VIEW"}},
				},
			},
		}
	...
	test.RunWithApp(t, func(app *server.App) {
		...
		testCases := []struct {
			...
			},
			{
				...
				statements: []*auth.AccessKeyStatement{
					{Effect: "Allow", Resource: "*", Actions: []string{"SELECT"}},
					{Effect: "Allow", Resource: fmt.Sprintf("database:%s:*", db.DatabaseId), Actions: []string{"FUNCTION"}},
				},
			},
			{
				...
				statements: []*auth.AccessKeyStatement{
					{Effect: "Allow", Resource: "*", Actions: []string{"SELECT"}},
					{Effect: "DENY", Resource: fmt.Sprintf("database:%s:*", db.DatabaseId), Actions: []string{"FUNCTION"}},
				},
			},
			{
				...
				statements: []*auth.AccessKeyStatement{
					{Effect: "Allow", Resource: "*", Actions: []string{"SELECT"}},
					{Effect: "Allow", Resource: fmt.Sprintf("database:%s:branch:%s:*", db.DatabaseId, db.BranchId), Actions: []string{"FUNCTION"}},
				},
			},
			{
				...
				statements: []*auth.AccessKeyStatement{
					{Effect: "Allow", Resource: "*", Actions: []string{"SELECT"}},
					{Effect: "DENY", Resource: fmt.Sprintf("database:%s:branch:%s:*", db.DatabaseId, db.BranchId), Actions: []string{"FUNCTION"}},
				},
			},
		}
	...
	test.RunWithApp(t, func(app *server.App) {
		...
		testCases := []struct {
			...
			},
			{
				...
				expectedError: nil,
				statements: []*auth.AccessKeyStatement{
					{Effect: "Allow", Resource: fmt.Sprintf("database:%s:*", db.DatabaseId), Actions: []string{"INSERT"}},
				},
			},
			{
				...
				expectedError: auth.NewDatabasePrivilegeError(auth.DatabasePrivilegeInsert),
				statements: []*auth.AccessKeyStatement{
					{Effect: "DENY", Resource: fmt.Sprintf("database:%s:*", db.DatabaseId), Actions: []string{"INSERT"}},
				},
			},
			{
				...
				expectedError: nil,
				statements: []*auth.AccessKeyStatement{
					{Effect: "Allow", Resource: fmt.Sprintf("database:%s:branch:%s:*", db.DatabaseId, db.BranchId), Actions: []string{"INSERT"}},
				},
			},
			{
				...
				expectedError: auth.NewDatabasePrivilegeError(auth.DatabasePrivilegeInsert),
				statements: []*auth.AccessKeyStatement{
					{Effect: "DENY", Resource: fmt.Sprintf("database:%s:branch:%s:*", db.DatabaseId, db.BranchId), Actions: []string{"INSERT"}},
				},
			},
		}
	...
	test.RunWithApp(t, func(app *server.App) {
		...
		testCases := []struct {
			...
			},
			{
				...
				expectedError: nil,
				statements: []*auth.AccessKeyStatement{
					{Effect: "Allow", Resource: fmt.Sprintf("database:%s:*", db.DatabaseId), Actions: []string{"PRAGMA"}},
				},
			},
			{
				...
				expectedError: auth.NewDatabasePrivilegeError(auth.DatabasePrivilegePragma),
				statements: []*auth.AccessKeyStatement{
					{Effect: "DENY", Resource: fmt.Sprintf("database:%s:*", db.DatabaseId), Actions: []string{"PRAGMA"}},
				},
			},
			{
				...
				expectedError: nil,
				statements: []*auth.AccessKeyStatement{
					{Effect: "Allow", Resource: fmt.Sprintf("database:%s:branch:%s:*", db.DatabaseId, db.BranchId), Actions: []string{"PRAGMA"}},
				},
			},
			{
				...
				expectedError: auth.NewDatabasePrivilegeError(auth.DatabasePrivilegePragma),
				statements: []*auth.AccessKeyStatement{
					{Effect: "DENY", Resource: fmt.Sprintf("database:%s:branch:%s:*", db.DatabaseId, db.BranchId), Actions: []string{"PRAGMA"}},
				},
			},
		}
	...
	test.RunWithApp(t, func(app *server.App) {
		...
		testCases := []struct {
			...
			},
			{
				...
				statements: []*auth.AccessKeyStatement{
					{Effect: "Allow", Resource: "*", Actions: []string{"SELECT"}},
					{Effect: "Allow", Resource: fmt.Sprintf("database:%s:*", db.DatabaseId), Actions: []string{"READ"}},
				},
			},
			{
				...
				statements: []*auth.AccessKeyStatement{
					{Effect: "Allow", Resource: "*", Actions: []string{"SELECT"}},
					{Effect: "DENY", Resource: fmt.Sprintf("database:%s:*", db.DatabaseId), Actions: []string{"READ"}},
				},
			},
			{
				...
				statements: []*auth.AccessKeyStatement{
					{Effect: "Allow", Resource: "*", Actions: []string{"SELECT"}},
					{Effect: "Allow", Resource: fmt.Sprintf("database:%s:branch:%s:*", db.DatabaseId, db.BranchId), Actions: []string{"READ"}},
				},
			},
			{
				...
				statements: []*auth.AccessKeyStatement{
					{Effect: "Allow", Resource: "*", Actions: []string{"SELECT"}},
					{Effect: "DENY", Resource: fmt.Sprintf("database:%s:branch:%s:*", db.DatabaseId, db.BranchId), Actions: []string{"READ"}},
				},
			},
		}
	...
	test.RunWithApp(t, func(app *server.App) {
		...
		testCases := []struct {
			...
			},
			{
				...
				statements: []*auth.AccessKeyStatement{
					{Effect: "Allow", Resource: "*", Actions: []string{"READ", "SELECT"}},
					{Effect: "Allow", Resource: fmt.Sprintf("database:%s:*", db.DatabaseId), Actions: []string{"RECURSIVE"}},
				},
			},
			{
				...
				statements: []*auth.AccessKeyStatement{
					{Effect: "Allow", Resource: "*", Actions: []string{"READ", "SELECT"}},
					{Effect: "DENY", Resource: fmt.Sprintf("database:%s:*", db.DatabaseId), Actions: []string{"RECURSIVE"}},
				},
			},
			{
				...
				statements: []*auth.AccessKeyStatement{
					{Effect: "Allow", Resource: "*", Actions: []string{"READ", "SELECT"}},
					{Effect: "Allow", Resource: fmt.Sprintf("database:%s:branch:%s:*", db.DatabaseId, db.BranchId), Actions: []string{"RECURSIVE"}},
				},
			},
			{
				...
				statements: []*auth.AccessKeyStatement{
					{Effect: "Allow", Resource: "*", Actions: []string{"READ", "SELECT"}},
					{Effect: "DENY", Resource: fmt.Sprintf("database:%s:branch:%s:*", db.DatabaseId, db.BranchId), Actions: []string{"RECURSIVE"}},
				},
			},
		}
	...
	test.RunWithApp(t, func(app *server.App) {
		...
		testCases := []struct {
			...
			},
			{
				...
				expectedError: nil,
				statements: []*auth.AccessKeyStatement{
					{Effect: "Allow", Resource: fmt.Sprintf("database:%s:*", db.DatabaseId), Actions: []string{"REINDEX"}},
				},
			},
			{
				...
				expectedError: auth.NewDatabasePrivilegeError(auth.DatabasePrivilegeReindex),
				statements: []*auth.AccessKeyStatement{
					{Effect: "DENY", Resource: fmt.Sprintf("database:%s:*", db.DatabaseId), Actions: []string{"REINDEX"}},
				},
			},
			{
				...
				expectedError: nil,
				statements: []*auth.AccessKeyStatement{
					{Effect: "Allow", Resource: fmt.Sprintf("database:%s:branch:%s:*", db.DatabaseId, db.BranchId), Actions: []string{"REINDEX"}},
				},
			},
			{
				...
				expectedError: auth.NewDatabasePrivilegeError(auth.DatabasePrivilegeReindex),
				statements: []*auth.AccessKeyStatement{
					{Effect: "DENY", Resource: fmt.Sprintf("database:%s:branch:%s:*", db.DatabaseId, db.BranchId), Actions: []string{"REINDEX"}},
				},
			},
		}
	...
	test.RunWithApp(t, func(app *server.App) {
		...
		testCases := []struct {
			...
			},
			{
				...
				expectedError: nil,
				statements: []*auth.AccessKeyStatement{
					{Effect: "Allow", Resource: fmt.Sprintf("database:%s:*", db.DatabaseId), Actions: []string{"SAVEPOINT"}},
				},
			},
			{
				...
				expectedError: auth.NewDatabasePrivilegeError(auth.DatabasePrivilegeSavepoint),
				statements: []*auth.AccessKeyStatement{
					{Effect: "DENY", Resource: fmt.Sprintf("database:%s:*", db.DatabaseId), Actions: []string{"SAVEPOINT"}},
				},
			},
			{
				...
				expectedError: nil,
				statements: []*auth.AccessKeyStatement{
					{Effect: "Allow", Resource: fmt.Sprintf("database:%s:branch:%s:*", db.DatabaseId, db.BranchId), Actions: []string{"SAVEPOINT"}},
				},
			},
			{
				...
				expectedError: auth.NewDatabasePrivilegeError(auth.DatabasePrivilegeSavepoint),
				statements: []*auth.AccessKeyStatement{
					{Effect: "DENY", Resource: fmt.Sprintf("database:%s:branch:%s:*", db.DatabaseId, db.BranchId), Actions: []string{"SAVEPOINT"}},
				},
			},
		}
	...
	test.RunWithApp(t, func(app *server.App) {
		...
		testCases := []struct {
			...
			},
			{
				...
				expectedError: nil,
				statements: []*auth.AccessKeyStatement{
					{Effect: "Allow", Resource: fmt.Sprintf("database:%s:*", db.DatabaseId), Actions: []string{"SELECT"}},
				},
			},
			{
				...
				expectedError: auth.NewDatabasePrivilegeError(auth.DatabasePrivilegeSelect),
				statements: []*auth.AccessKeyStatement{
					{Effect: "DENY", Resource: fmt.Sprintf("database:%s:*", db.DatabaseId), Actions: []string{"SELECT"}},
				},
			},
			{
				...
				expectedError: nil,
				statements: []*auth.AccessKeyStatement{
					{Effect: "Allow", Resource: fmt.Sprintf("database:%s:branch:%s:*", db.DatabaseId, db.BranchId), Actions: []string{"SELECT"}},
				},
			},
			{
				...
				expectedError: auth.NewDatabasePrivilegeError(auth.DatabasePrivilegeSelect),
				statements: []*auth.AccessKeyStatement{
					{Effect: "DENY", Resource: fmt.Sprintf("database:%s:branch:%s:*", db.DatabaseId, db.BranchId), Actions: []string{"SELECT"}},
				},
			},
		}
	...
	test.RunWithApp(t, func(app *server.App) {
		...
		testCases := []struct {
			...
			},
			{
				...
				expectedError: nil,
				statements: []*auth.AccessKeyStatement{
					{Effect: "Allow", Resource: fmt.Sprintf("database:%s:*", db.DatabaseId), Actions: []string{"TRANSACTION"}},
				},
			},
			{
				...
				expectedError: auth.NewDatabasePrivilegeError(auth.DatabasePrivilegeTransaction),
				statements: []*auth.AccessKeyStatement{
					{Effect: "DENY", Resource: fmt.Sprintf("database:%s:*", db.DatabaseId), Actions: []string{"TRANSACTION"}},
				},
			},
			{
				...
				expectedError: nil,
				statements: []*auth.AccessKeyStatement{
					{Effect: "Allow", Resource: fmt.Sprintf("database:%s:branch:%s:*", db.DatabaseId, db.BranchId), Actions: []string{"TRANSACTION"}},
				},
			},
			{
				...
				expectedError: auth.NewDatabasePrivilegeError(auth.DatabasePrivilegeTransaction),
				statements: []*auth.AccessKeyStatement{
					{Effect: "DENY", Resource: fmt.Sprintf("database:%s:branch:%s:*", db.DatabaseId, db.BranchId), Actions: []string{"TRANSACTION"}},
				},
			},
		}
	...
	test.RunWithApp(t, func(app *server.App) {
		...
		testCases := []struct {
			...
			},
			{
				...
				statements: []*auth.AccessKeyStatement{
					{Effect: "Allow", Resource: "*", Actions: []string{"READ"}},
					{Effect: "Allow", Resource: fmt.Sprintf("database:%s:*", db.DatabaseId), Actions: []string{"UPDATE"}},
				},
			},
			{
				...
				statements: []*auth.AccessKeyStatement{
					{Effect: "Allow", Resource: "*", Actions: []string{"READ"}},
					{Effect: "DENY", Resource: fmt.Sprintf("database:%s:*", db.DatabaseId), Actions: []string{"UPDATE"}},
				},
			},
			{
				...
				statements: []*auth.AccessKeyStatement{
					{Effect: "Allow", Resource: "*", Actions: []string{"READ"}},
					{Effect: "Allow", Resource: fmt.Sprintf("database:%s:branch:%s:*", db.DatabaseId, db.BranchId), Actions: []string{"UPDATE"}},
				},
			},
			{
				...
				statements: []*auth.AccessKeyStatement{
					{Effect: "Allow", Resource: "*", Actions: []string{"READ"}},
					{Effect: "DENY", Resource: fmt.Sprintf("database:%s:branch:%s:*", db.DatabaseId, db.BranchId), Actions: []string{"UPDATE"}},
				},
			},
		}
