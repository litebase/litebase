...
// func ClearFSFiles(c *config.Config) {
// 	if c.StorageTieredMode == config.StorageModeDistributed && tieredFileSystem != nil {
...
// 			NewLocalFileSystemDriver(
// 				fmt.Sprintf("%s/%s", config.Get().DataPath, config.StorageModeLocal),
// 			),
// 		)
// 	}
...
// 		if config.Get().StorageObjectMode == config.StorageModeLocal {
// 			objectFileSystem = NewFileSystem(NewLocalFileSystemDriver(fmt.Sprintf("%s/%s", config.Get().DataPath, config.StorageModeObject)))
// 		} else {
...
// 		if config.Get().StorageTieredMode == config.StorageModeObject {
...
// 				),
// 			)
// 		} else if config.Get().StorageTieredMode == config.StorageModeDistributed {
// 			tieredFileSystem = NewFileSystem(
...
// 				),
// 			)
// 		} else if config.Get().StorageTieredMode == config.StorageModeLocal {
// 			tieredFileSystem = NewFileSystem(
// 				NewTieredFileSystemDriver(
// 					GetStorageContext(),
// 					NewLocalFileSystemDriver(fmt.Sprintf("%s/%s", config.Get().DataPath, "tiered")),
// 					NewLocalFileSystemDriver(fmt.Sprintf("%s/%s", config.Get().DataPath, config.StorageModeObject)),
// 				),
// 			)
// 		}
// 	}
